...
enum opt_code
{
  ...
  OPT_mbionic = 1599,                        /* -mbionic */
  OPT_mbranch_cost_ = 1600,                  /* -mbranch-cost= */
  OPT_mcmodel_ = 1601,                       /* -mcmodel= */
  OPT_mcpu_ = 1602,                          /* -mcpu= */
  OPT_mdiv = 1603,                           /* -mdiv */
  OPT_mexplicit_relocs = 1604,               /* -mexplicit-relocs */
  OPT_mfdiv = 1605,                          /* -mfdiv */
  OPT_mglibc = 1606,                         /* -mglibc */
  OPT_mmusl = 1607,                          /* -mmusl */
  OPT_mplt = 1608,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1609,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1610,                         /* -mrelax */
  OPT_mriscv_attribute = 1611,               /* -mriscv-attribute */
  OPT_msave_restore = 1612,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1613,               /* -mshorten-memrefs */
  OPT_msmall_data_limit_ = 1614,             /* -msmall-data-limit= */
  OPT_mstrict_align = 1615,                  /* -mstrict-align */
  OPT_mtune_ = 1616,                         /* -mtune= */
  OPT_muclibc = 1617,                        /* -muclibc */
  OPT_n = 1618,                              /* -n */
  OPT_name_sort = 1619,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1620,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1621,              /* -no-integrated-cpp */
  OPT_no_pie = 1622,                         /* -no-pie */
  OPT_nocpp = 1623,                          /* -nocpp */
  OPT_nodefaultlibs = 1624,                  /* -nodefaultlibs */
  OPT_nolibc = 1625,                         /* -nolibc */
  OPT_nophoboslib = 1626,                    /* -nophoboslib */
  OPT_nostartfiles = 1627,                   /* -nostartfiles */
  OPT_nostdinc = 1628,                       /* -nostdinc */
  OPT_nostdinc__ = 1629,                     /* -nostdinc++ */
  OPT_nostdlib = 1630,                       /* -nostdlib */
  OPT_o = 1631,                              /* -o */
  OPT_objects = 1632,                        /* -objects */
  OPT_p = 1633,                              /* -p */
  OPT_pass_exit_codes = 1634,                /* -pass-exit-codes */
  /* OPT_pedantic = 1635, */                 /* -pedantic */
  OPT_pedantic_errors = 1636,                /* -pedantic-errors */
  OPT_pg = 1637,                             /* -pg */
  OPT_pie = 1638,                            /* -pie */
  OPT_pipe = 1639,                           /* -pipe */
  OPT_posix = 1640,                          /* -posix */
  ...
  OPT_profile = 1653,                        /* -profile */
  OPT_pthread = 1654,                        /* -pthread */
  OPT_quiet = 1655,                          /* -quiet */
  OPT_r = 1656,                              /* -r */
  OPT_rdynamic = 1657,                       /* -rdynamic */
